...
async fn build_payload_v5(
    ...
    // on this receive path either — felix314159/hive#3
    // testForkchoiceUpdatedAcceptsLargeIL explicitly exercises a 10 KiB IL
    // and expects FCU V5 to succeed; the 8 KiB cap applies only to what
    // engine_getInclusionListV1 BUILDS.
